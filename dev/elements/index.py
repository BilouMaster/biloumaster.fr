...
class Index(Page):
    ...
    def spec_args(self, args, lang='fr') -> dict:
        ...
        args['meta_title'] = config.sitename + ' - Créations artistiques, jeux vidéo et compositions musicales'
        args['meta_description'] = 'Artiste, développeur de jeux vidéo et compositeur amateur/autodidacte. Découvrez mes créations graphiques, jeux indépendants et albums musicaux.'
