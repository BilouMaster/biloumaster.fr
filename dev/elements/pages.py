...
class Page(Element):
    ...
    def html_content(self, lang='fr') -> str:
        ...
        if self.name in ['creations', 'tradi']:
            ...
            all.html()
            return super().html_content(lang) + f"<p class='info'><i>Z'aimez pas les sous-catégories ?</i> Vous pouvez aussi voir <a href='{self.url}/tout-en-vrac'>tout en vrac !<img src='/img/ui/tout-en-vrac.svg' alt=''></a></p>"
